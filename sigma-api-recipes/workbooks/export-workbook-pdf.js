...
const baseURL = 'https://aws-api.sigmacomputing.com/v2'; // Base URL for the Sigma API
const workbookId = '29z2Jg1ww2LXiYd6BVeOh3'; // Workbook ID from which to export data
